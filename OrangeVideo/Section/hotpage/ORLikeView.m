...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.likeBeforeImgView.frame = CGRectMake(0, 0, 24, 24);
        self.likeAfterImgView.frame  = CGRectMake(0, 0, 24, 24);
...
//    }
    ...
    if (self.likeViewAction) {
        self.likeViewAction(self.isLike);
    }
}
...
- (UILabel *)countLabel {
    if (!_countLabel) {
        ...
        _countLabel.font = zy_mediumSystemFont13;
    }
    return _countLabel;
}
