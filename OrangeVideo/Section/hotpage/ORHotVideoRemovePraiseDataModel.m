//
//  ORHotVideoRemovePraiseDataModel.m
//  OrangeVideo
//
...
@implementation ORHotVideoRemovePraiseDataModel

- (instancetype)init
{
    self = [super init];
    if (self) {
        self.address = [NSString gnh_addressWithString:ORRemovePraiseAddress];
...
- (BOOL)removePraiseWithType:(NSString *)videoId type:(NSString *)type
{
    if (self.isLoading) {
        return NO;
    }
