...
@interface ORAboutMeViewController ()

@end

@implementation ORAboutMeViewController
...
- (void)setupUI
{
    ...
    UIImageView *iconImageView = [UIImageView ly_ImageViewWithImageName:@"logo"];
