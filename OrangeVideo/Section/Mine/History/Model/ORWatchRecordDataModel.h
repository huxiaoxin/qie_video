...
@interface ORWatchRecordDataItem : GNHBaseItem
...
@interface ORWatchRecordItem : GNHRootBaseItem
@property (nonatomic, strong) NSMutableArray <__kindof ORWatchRecordDataItem *> *list; // 数据流
...
@interface ORWatchRecordDataModel : GNHBaseDataModel
@property (nonatomic, strong) ORWatchRecordItem *watchRecordItem;
