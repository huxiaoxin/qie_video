...
@interface ORHotVideoDetailItem : GNHRootBaseItem
...
@interface ORHotVideoDetailDataModel : GNHBaseDataModel
@property (nonatomic, strong) ORHotVideoDetailItem *hotVideoDetailItem;
