...
#import "ORLineLoadingView.h"

#define GKLineLoadingDuration  0.75
#define GKLineLoadingLineColor [UIColor whiteColor]

@implementation ORLineLoadingView

+ (void)showLoadingInView:(UIView *)view withLineHeight:(CGFloat)lineHeight {
    ORLineLoadingView *loadingView = [[ORLineLoadingView alloc] initWithFrame:view.frame lineHeight:lineHeight];
...
+ (void)hideLoadingInView:(UIView *)view {
    ...
    for (UIView *subView in subviewsEnum) {
        if ([subView isKindOfClass:[ORLineLoadingView class]]) {
            ORLineLoadingView *loadingView = (ORLineLoadingView *)subView;
