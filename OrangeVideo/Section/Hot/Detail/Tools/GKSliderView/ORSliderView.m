...
- (void)showLineLoading {
    [ORLineLoadingView showLoadingInView:self withLineHeight:self.gk_height];
}

- (void)hideLineLoading {
    [ORLineLoadingView hideLoadingInView:self];
}
