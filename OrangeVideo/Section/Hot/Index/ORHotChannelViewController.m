...
@property (nonatomic, strong) ORHotChannelDataModel *hotChannelDataModel; // 数据
...
{
    if ([item isKindOfClass:[ORHotChannelDataItem class]]) {
...
- (void)configForCell:(GNHBaseTableViewCell *)cell item:(id)item
{
    if ([item isKindOfClass:[ORHotChannelDataItem class]]) {
        ...
        channelTableViewCell.hotChannelActionBlock = ^(ORHotChannelDataItem * _Nonnull dataItem, ORHotChannelActionType type) {
            switch (type) {
                case ORHotChannelActionTypeMore: {
                    ...
                    [weakSelf gnh_showSheetWithTitle:nil message:nil appearanceProcess:^(GNHAlertController *alertMaker) {
                        ...
                        [tmpArr enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
                            ORHotChannelDataItem *cellItem = (ORHotChannelDataItem *)obj;
                ...
                default: {
                    // 播放
                    ORHotDetailViewController *hotDetailVC = [[ORHotDetailViewController alloc] initWithVideos:@[dataItem] index:0];
...
- (NSMutableArray *)filterData:(NSMutableArray <__kindof ORHotChannelDataItem *> *)list
{
    NSMutableArray <__kindof ORHotChannelDataItem *> *tmpArr = [list mutableCopy];
    ...
    [keys enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        [list enumerateObjectsUsingBlock:^(__kindof ORHotChannelDataItem * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
...
- (void)handleDataModelSuccess:(GNHBaseDataModel *)gnhModel
{
    ...
    if ([gnhModel isMemberOfClass:[ORHotChannelDataModel class]]) {
        GNHTableViewSectionObject *sectionObject = self.sections.firstObject;
...
- (ORHotChannelDataModel *)hotChannelDataModel
{
    if (!_hotChannelDataModel) {
        _hotChannelDataModel = [self produceModel:[ORHotChannelDataModel class]];
    }
