...
@property (nonatomic, strong) ORHotChannelDataItem *channelItem;
...
- (void)setupSubviews
{
    ...
    UIView *bottomView = [UIView ly_ViewWithColor:gnh_color_b];
    ...
    UILabel *timeLabel = [UILabel ly_LabelWithTitle:@"" font:zy_mediumSystemFont14 titleColor:gnh_color_p];
