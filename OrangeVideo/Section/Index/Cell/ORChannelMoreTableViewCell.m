...
@property (nonatomic, strong) ORIndexChannelItem *recommendChannelItem;
...
{
    ORIndexChannelItem *channelItem = (ORIndexChannelItem *)item;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.recommendChannelItem.list.count) {
        ORVideoBaseItem *channelBaseItem = (ORVideoBaseItem *)[self.recommendChannelItem.list mdf_safeObjectAtIndex:indexPath.row];
