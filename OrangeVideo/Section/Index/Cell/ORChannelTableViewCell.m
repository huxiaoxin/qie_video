...
@property (nonatomic, strong) ORChannelBaseItemView *channelItemView;
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ORChannelBaseItemView *channelItemView = [[ORChannelBaseItemView alloc] init];
...
@interface ORChannelTableViewCell () <UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
@implementation ORChannelTableViewCell
...
- (void)setupSubviews
{
    ...
    UIView *topView = [UIView ly_ViewWithColor:gnh_color_b];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.channelItem.videoDtoList.count) {
        ORVideoBaseItem *channelBaseItem = (ORVideoBaseItem *)[self.channelItem.videoDtoList mdf_safeObjectAtIndex:indexPath.row];
