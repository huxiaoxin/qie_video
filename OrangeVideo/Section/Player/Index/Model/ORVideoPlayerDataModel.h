...
@interface ORVideoSourceItem : GNHBaseItem
...
@interface ORVideoDetailItem : GNHRootBaseItem
...
@property (nonatomic, strong) ORVideoSourceItem *source;  // 视频来源
@property (nonatomic, strong) NSMutableArray <__kindof ORVideoSourceItem *> *sourceList; // 当前视频播放源集合
...
@interface ORVideoPlayerDataModel : GNHBaseDataModel 
