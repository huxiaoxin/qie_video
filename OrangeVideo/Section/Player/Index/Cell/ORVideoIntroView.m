...
@interface ORVideoIntroView () <UITextViewDelegate>
...
@implementation ORVideoIntroView
...
+ (LYCoverView *)showIntroAlertView:(ORVideoDetailItem *)detailItem completeBlock:(ORVideoIntroCompleteBlock)completeBlock
{
    ...
    ORVideoIntroView *contentView = [[ORVideoIntroView alloc] initWithFrame:CGRectMake(0, kScreenHeight, kScreenWidth, kScreenHeight - orgin_y)];
