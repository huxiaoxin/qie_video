//
//  ORVideoRecommendTableViewCell.m
//  OrangeVideo
//
...
@property (nonatomic, strong) ORVideoRecommendView *channelItemView;

- (void)reloadCollectionViewData:(ORVideoBaseItem *)dataItem;
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ORVideoRecommendView *channelItemView = [[ORVideoRecommendView alloc] init];
...
@interface ORVideoRecommendTableViewCell () <UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
@implementation ORVideoRecommendTableViewCell
...
- (void)setItem:(id<GNHBaseActionItemProtocol>)item
{
    if ([item isKindOfClass:[ORVideoRecommendItem class]]) {
        ORVideoRecommendItem *videoRecommendItem = (ORVideoRecommendItem *)item;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.videoRecommendItem.data.count) {
        ORVideoBaseItem *channelBaseItem = (ORVideoBaseItem *)[self.videoRecommendItem.data mdf_safeObjectAtIndex:indexPath.row];
