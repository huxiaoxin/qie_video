...
@interface ORVideoEpisodesView () <UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
@property (nonatomic, weak) LYCoverView *backView;
@property (nonatomic, strong) UICollectionView *collectionView;
@property (nonatomic, strong) UIButton *closeBtn;

@property (nonatomic, strong) ORVideoDetailItem *videoDetailItem;
@property (nonatomic, strong) NSIndexPath *selectIndexPath;

@end

@implementation ORVideoEpisodesView
...
+ (LYCoverView *)showIntroAlertView:(ORVideoDetailItem *)detailItem completeBlock:(ORVideoEpisodesCompleteBlock)completeBlock
{
    ...
    ORVideoEpisodesView *contentView = [[ORVideoEpisodesView alloc] initWithFrame:CGRectMake(0, kScreenHeight, kScreenWidth, kScreenHeight - orgin_y)];
