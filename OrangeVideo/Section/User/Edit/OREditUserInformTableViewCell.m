//
//  OREditUserInformTableViewCell.m
//  OrangeVideo
//
...
@implementation OREditUserInformCellItem

@end

@interface OREditUserInformTableViewCell () <UITextFieldDelegate>
...
@implementation OREditUserInformTableViewCell
...
- (void)setItem:(id<GNHBaseActionItemProtocol>)item
{
    ...
    if ([item isKindOfClass:[OREditUserInformCellItem class]]) {
        OREditUserInformCellItem *cellItem = (OREditUserInformCellItem *)item;
