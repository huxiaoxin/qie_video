...
@interface ZYAgreementHints ()<UITextViewDelegate>
...
@end
@implementation ZYAgreementHints
...
- (void)configUI {
    ...
    UILabel *titleLb = [UILabel ly_LabelWithTitle:@"熊猫追剧" font:[UIFont boldSystemFontOfSize:16] titleColor:gnh_color_a];
