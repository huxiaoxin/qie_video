...
@implementation ZYBriefMemberItem
@end

@interface ORAccountComponent ()

@property (nonatomic, strong) MDFDBStorage *storage;
@property (nonatomic, strong) ZYBriefMemberItem *memberItem;
@property (nonatomic, strong) NSMutableDictionary *userInfo;

@end

@implementation ORAccountComponent
...
- (void)storeUserItem:(ZYBriefMemberItem *)loginUserInfo
{
    [self storeUserItem:loginUserInfo accountChangeNotify:YES];
}

- (void)storeUserItem:(ZYBriefMemberItem *)loginUserInfo accountChangeNotify:(BOOL)notify
{
    NSError *error = nil;
    if (loginUserInfo) {
