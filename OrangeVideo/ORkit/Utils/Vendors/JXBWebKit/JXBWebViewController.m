...
#define kJXBSafeAreaTopHeight       ([UIDevice ly_hasFringeScreen] ? 88 : 64)
#define kJXBSafeAreaBottomHeight    ([UIDevice ly_hasFringeScreen] ? 34 : 0)
...
- (void)initData {
    ...
    _terminate                  = NO;
    _backItemImgName            = @"com_back";
    _closeItemImgName           = @"com_close";
...
- (void)updateFrameOfProgressView {
    ...
    BOOL isIphoneX = [UIDevice ly_hasFringeScreen];
...
- (UIBarButtonItem *)backNavLeftItem {
    ...
    if (self.isHiddleLeftItemBar) {
        return nil;
    }
    
    UIImage *backImage = [[UIImage imageNamed:_backItemImgName] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
