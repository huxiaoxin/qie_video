...
- (NSMutableArray *)platformArray {
    if (!_platformArray || !_platformArray.count) {
        ...
        if ([WXApi isWXAppInstalled]) {
            ...
            wxButton.platformIconImage = [UIImage imageNamed:@"share_wechat"];
            wxButton.platformIconHightLightImage = [UIImage imageNamed:@"share_wechat"];
        ...
        if ([WXApi isWXAppInstalled]) {
            ...
            wxSessionButton.platformIconImage = [UIImage imageNamed:@"share_friend"];
            wxSessionButton.platformIconHightLightImage = [UIImage imageNamed:@"share_friend"];
        ...
        if ([TencentOAuth iphoneQQInstalled]) {
            ...
            qqButton.platformIconImage = [UIImage imageNamed:@"share_qq"];
            qqButton.platformIconHightLightImage = [UIImage imageNamed:@"share_qq"];
        ...
        if ([TencentOAuth iphoneQQInstalled]) {
            ...
            qqzoneButton.platformIconImage = [UIImage imageNamed:@"share_qqzone"];
            qqzoneButton.platformIconHightLightImage = [UIImage imageNamed:@"share_qqzone"];
